          ...
          > 
              ...
              <View style={styles.containerEstadoMaquina}> 
                ...
                <TextInput
                  ...
                  placeholder="Descreva anomalias ou estado operacional..."
                  multiline={true}
                  value={maquinas}
              ...
              <View style={styles.containerEstadoMaterias}>
                ...
                <TextInput
                  style={styles.inputMultilinha}
                  placeholder="Nível de estoque e insumos..."
                  multiline={true}
                  value={materiais}
              ...
              <View style={styles.containerIncidentesAnomalias}>
                ...
                <TextInput
                  style={styles.inputMultilinha}
                  placeholder="Reporte falhas ou paradas..."
                  multiline={true}
                  value={incidentes}
...
const styles = StyleSheet.create({
  containerHomeScreen: { alignItems: 'center', backgroundColor: '#F5F5F5' },
  headerHome: { width: '100%', padding: 20 },
  titleHome: { fontSize: 24, fontWeight: '900', color: '#000' },
  SubTitleHome: { fontSize: 14, color: '#6B7280', marginTop: 4 },
  divTurno: { width: '90%', backgroundColor: '#FFF', borderRadius: 12, padding: 16, flexDirection: 'row', marginTop: 10, borderWidth: 1, borderColor: '#E5E7EB', elevation: 2 },
  containerIndMaq: { width: '90%', backgroundColor: '#FFF', borderRadius: 12, padding: 16, marginTop: 20, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  bullet: { fontSize: 18, marginRight: 5 },
  dateText: { fontSize: 14, color: '#6B7280' },
  titleIndMaq: { fontSize: 16, fontWeight: '700', color: '#1F2937' },
  inputIndMaq: { backgroundColor: '#F3F4F6', borderRadius: 8, padding: 12, color: '#374151', borderWidth: 1, borderColor: '#E5E7EB', marginTop: 10 },
