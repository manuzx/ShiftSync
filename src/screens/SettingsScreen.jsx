...
// Importando o hook do contexto
import { useAuth } from '../context/AuthContext'; 

export default function SettingsScreen() {
  // Puxando themeColor e a função de atualização do contexto
  ...
  // Função para lidar com a troca de turno e cor
  const handleShiftChange = (shift) => {
    setSelectedShift(shift);
    atualizarTurnoGlobal(shift); // Atualiza a cor no contexto global
  };
    ...
    <SafeAreaView style={styles.container} edges={['left', 'right', 'bottom']}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          {/* Botão de salvar usando a cor dinâmica */}
          <TouchableOpacity 
